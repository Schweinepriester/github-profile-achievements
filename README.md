...
|-------------------------------|------------------------------------------------------------------------------------------------------|----------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Heart On Your Sleeve          | ![Heart On Your Sleeve Badge](images/heart-on-your-sleeve-default.png)                               | (Being tested)                                     | React to something on GitHub with a ❤️ emoji (follow the [news](https://github.blog/?s=achievement) on GitHub Blog)                                                                  |
| Open Sourcerer                | ![Open Sourcerer Badge](images/open-sourcerer-default.png)                                           | (Being tested)                                     | User had PRs merged in multiple public repositories (follow the [news](https://github.blog/?s=achievement) on GitHub Blog)                                                           |
...
There ~~is~~ was
an [official list](https://docs.github.com/en/account-and-profile/setting-up-and-managing-your-github-profile/customizing-your-profile/personalizing-your-profile#displaying-badges-on-your-profile)
available in the GitHub Docs. There is still a section that includes specifics on how badges were/are awarded, e.g.
