...
| --- | --- | --- | --- |
Heart On Your Sleeve | ![Heart On Your Sleeve Badge](/images/heart-on-your-sleeve-default.png) | ✔️ | publicly a project on GitHub that contains a valid LICENSE file and a README file
Open Sourcerer | ![Open Sourcerer Badge](/images/open-sourcerer-default.png) | ✔️ | make a qualifying contribution to project (fixing a bug, adding a new feature, improving documentation, submitting a new translation...) that must be accepted and merged into the main repository by the project maintainers
